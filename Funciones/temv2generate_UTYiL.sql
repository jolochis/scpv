		...
		IF (SELECT "idPropuesta" FROM segments WHERE "idPropuesta" = $1 LIMIT 1) IS NULL THEN
			...
			LOOP
				...
				ELSE
					...
					OPEN punkte FOR SELECT DISTINCT(coor),lanes,ST_Line_Locate_point(strasse::geometry,coor::geometry) as pos,
					...
					fetch punkte into I1, c1, pos1, stype1, type1;
					-- primer punto encontrado								
					
					LOOP
						fetch punkte into I2, c2, pos2, stype2, type2;
						...
						ELSE
							...
							ELSE 
								...
								auxpos2 := pos1;
							END IF;
							RAISE warning '++++++++++++pos1:% pos2:%',auxpos1, auxpos2;
							INSERT INTO "tempMatriz" SELECT I1name, auxpos1, c1, c2,I1, (createIntersections(c1,c2,S1name,strasseid))
